"""Async helper functions for API modules using httpx."""
...
async def fetch_and_cache_text_async(
    client: httpx.AsyncClient,
    cache_key: str,
    url: str,
    timeout: float = 10.0,
    ...
    """Fetch text content from URL with caching and async rate limiting.
